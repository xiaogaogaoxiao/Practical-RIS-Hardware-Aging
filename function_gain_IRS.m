function [output_gain_IRS]=function_gain_IRS(p1, p2, ~, ~, isotropic)
...
% Example:
%
% p1 = eye(3);p2 = [1,2,3;4,5,6;7,8,9]; dx=0.1;dy=0.2;isotropic = 0; [output_gain_IRS]=function_gain_IRS(p1, p2, dx, dy, isotropic)
% output_gain_IRS =
%
%    13.4020   11.7197    9.6856
